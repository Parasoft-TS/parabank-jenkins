        ...
        stage('SOAtest: Functional Test') {
            ...
            steps {
                ...
                sh  '''
                    ...
                    certutil -d sql:$HOME/.pki/nssdb -A -t "C,," -n ParasoftCert -i /usr/local/parasoft/soavirt_workspace/SOAtestProject/seleniumscreenshot.jar > ./parabank-jenkins/soatest/report/AddingCert.txt
