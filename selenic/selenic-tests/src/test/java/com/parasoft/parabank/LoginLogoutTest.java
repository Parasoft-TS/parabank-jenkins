...
public class LoginLogoutTest {
	 ...
	 */
	private static String PARABANK_BASE_URL;
	...
	public void beforeTest() {
		// Base URL
		PARABANK_BASE_URL = System.getProperty("PARABANK_BASE_URL", "http://parabank-baseline:8090");

		// Chrome Driver
		//CHROME_DRIVER = System.getProperty("CHROME_DRIVER", "/opt/selenium/chromedriver-128.0.6613.86");

		// Grid URL
		GRID_URL = System.getProperty("GRID_URL", "http://selenium-grid:4444/wd/hub");
